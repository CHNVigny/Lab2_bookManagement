...
<html>
  ...
  <%String name=request.getParameter("name");%>
    <h3 align="center" class="demo-logo">Success! </h3><br>
    <div align="center"><br>
  <div class="container"> 
   ...
   <div class="container"> 
      <div class="row demo-row">
        <div class="span3">
          <div align="center"><a href="SearchAccordingToAuthor.jsp?name=<%=name%>" class="btn btn-large btn-block btn-danger">查看作者</a></div>
        </div>
      </div> <!-- /row -->
    </div> <!-- /container -->
   <br>
